...
👈 برای دریافت رژیم، گزینه دریافت رژیم رو در منو انتخاب کن.');
    ...
    public function setPackage($user_id)
    {
        ...
        if ($userPay != null) {
            ...
            ], '🎉 ممنون از تکمیل مراحل!

برای دریافت رژیم ۷ روزه اختصاصی فقط کافیه از طریق دکمه زیر پرداخت رو انجام بدید:

✅ هزینه: ۸۸ هزار تومان
🔒 پرداخت امن از درگاه رسمی با نماد اعتماد

⚠️ لطفاً قبل از پرداخت، فیلترشکن (VPN) خود را خاموش کنید.
